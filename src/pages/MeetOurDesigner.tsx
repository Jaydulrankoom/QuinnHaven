...
export default function MeetOurDesigner() {
  return (
    <div className="flex flex-col min-h-screen bg-cream font-sans text-charcoal">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-24 overflow-hidden border-b border-charcoal/5">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-serif text-brand leading-[1.1] mb-8 font-light"
          >
            Meet Our <span className="italic text-brand">Designer</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative overflow-hidden rounded-sm shadow-2xl">
                <img loading="lazy" 
                  ...
                  className="w-full h-auto aspect-[4/5] object-cover object-top bg-charcoal/5"
                />
              </div>
              <div className="absolute -bottom-10 -right-4 lg:-right-12 bg-white p-8 shadow-xl border border-charcoal/5 hidden md:block max-w-[280px]">
                 <p className="font-serif text-brand text-2xl mb-1">Amanda Lai</p>
                 <p className="text-brand uppercase tracking-widest text-xs font-bold block">Lead Designer & CEO</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold">
                  Background
                </span>
              </div>
              <h2 className="font-serif text-3xl md:text-5xl text-brand mb-10 leading-[1.2]">A Thoughtful Design Perspective</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10 border-t border-charcoal/10">
                 <div className="flex flex-col gap-4 group">
                   <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm border border-charcoal/5 group-hover:border-brand/30 transition-colors">
                     <Globe className="w-5 h-5 text-brand" />
                   </div>
                   <h4 className="font-bold text-brand text-sm uppercase tracking-wider">Global Experience</h4>
                 ...
                 <div className="flex flex-col gap-4 group">
                   ...
                   <h4 className="font-bold text-brand text-sm uppercase tracking-wider">Practical Elegance</h4>
      ...
      <section className="py-32 bg-brand relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold mb-8 block">The Philosophy</span>
          ...
          <div className="flex items-center justify-center gap-4">
             ...
             <span className="block text-sm font-bold uppercase tracking-widest text-brand text-center">
               Amanda Lai
             </span>
             <div className="h-[1px] w-8 bg-brand"></div>
          </div>
      ...
      <section className="bg-white py-32 text-center border-t border-charcoal/5">
        <div className="max-w-3xl mx-auto px-6">
          <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold mb-6 block">Take the Next Step</span>
          <h2 className="text-4xl md:text-5xl text-brand font-serif mb-8 leading-tight">Ready to collaborate?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link 
              to="/contact" 
              className="inline-block bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-semibold hover:bg-charcoal transition-colors duration-300"
            >
              Book a Consultation
            </Link>
            <Link 
              to="/showroom" 
              className="inline-block bg-white text-brand border border-brand/20 px-10 py-5 uppercase tracking-widest text-sm font-semibold hover:bg-brand/5 transition-colors duration-300"
            >
               Visit Showroom
            </Link>
          </div>

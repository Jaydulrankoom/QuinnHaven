    ...
    <div className="flex flex-col min-h-screen pt-0 bg-cream font-sans text-charcoal">
      ...
      <section className="relative h-[75vh] min-h-[600px] w-full overflow-hidden bg-charcoal flex items-center justify-center text-center pt-24">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-white mt-12">
          <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold mb-6 block">Rooted in Design, Driven by Passion</span>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif leading-tight mb-8 font-light">
            Bringing your <span className="italic text-brand-accent">dream home</span> to life.
          </h1>
          ...
          <Link 
            to="/showroom" 
            className="inline-block bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-medium hover:bg-charcoal hover:text-white transition-all duration-300 shadow-xl"
          >
            Visit Our Showroom
          </Link>
        </div>
      ...
      <section className="py-24 bg-cream relative z-10">
        <div className="max-w-5xl mx-auto px-6 text-center">
           <p className="text-xl md:text-2xl font-light text-charcoal/80 leading-relaxed mb-12 italic border-l-4 border-brand pl-6 md:pl-8 text-left">
             ...
             <span className="block mt-6 text-sm font-bold uppercase tracking-widest text-brand not-italic">— Amanda Lai, CEO QuinnHaven Design</span>
           </p>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto border-t border-charcoal/5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
           ...
           <div className="order-1 md:order-2">
              <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Our Origin Story</span>
              <h2 className="text-3xl lg:text-4xl font-serif text-brand mb-6">Built on Uncompromising Quality</h2>
      ...
      <section className="py-24 bg-white border-y border-charcoal/5">
         <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
               <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">The Difference</span>
               <h2 className="text-3xl lg:text-4xl font-serif text-brand">Why Choose QuinnHaven</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
               {/* Tailored */}
               <div className="bg-cream border border-charcoal/5 p-10 hover:border-brand transition-colors shadow-sm">
                  <LayoutTemplate className="w-10 h-10 text-brand mb-6" />
               ...
               {/* Process */}
               <div className="bg-cream border border-charcoal/5 p-10 hover:border-brand transition-colors shadow-sm">
                  <CheckCircle2 className="w-10 h-10 text-brand mb-6" />
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto bg-cream">
         <div className="bg-white shadow-xl flex flex-col md:flex-row overflow-hidden rounded-sm border border-charcoal/5">
            <div className="w-full md:w-1/2 p-12 md:p-16 flex flex-col justify-center">
               <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Our Home Base</span>
               <h2 className="text-3xl font-serif text-brand mb-6">Rooted in Connecticut</h2>
      ...
      <section className="py-24 bg-white border-t border-charcoal/5 text-center">
         <div className="max-w-2xl mx-auto px-6">
            <h2 className="text-3xl font-serif text-brand mb-6">Let's talk about your space.</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
               <a href={`tel:${BRAND.phone}`} className="flex items-center gap-2 text-charcoal hover:text-brand transition-colors">
                  <Phone className="w-4 h-4 text-brand" />
                  <span className="font-medium">{BRAND.phone}</span>
               </a>
               <span className="hidden sm:block text-charcoal/20">|</span>
               <a href={`mailto:${BRAND.email}`} className="flex items-center gap-2 text-charcoal hover:text-brand transition-colors">

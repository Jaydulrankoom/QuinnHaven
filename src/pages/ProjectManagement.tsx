    ...
    <div className="flex flex-col min-h-screen pt-0 bg-cream font-sans text-charcoal">
      ...
      <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden bg-charcoal flex items-center justify-center text-center pt-24">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-white mt-8">
          ...
          >
            Seamless Execution. <span className="italic text-brand-accent">From Concept to Completion.</span>
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white border-y border-charcoal/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Expertise</span>
            <h2 className="text-3xl lg:text-4xl font-serif text-brand">What We Do</h2>
            <p className="mt-4 text-charcoal/70 font-light max-w-2xl mx-auto text-lg hover:text-brand transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-cream p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors group">
              <CalendarClock className="w-10 h-10 text-brand mb-6 group-hover:scale-110 transition-transform origin-left" />
            ...
            <div className="bg-cream p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors group">
              <CircleDollarSign className="w-10 h-10 text-brand mb-6 group-hover:scale-110 transition-transform origin-left" />
            ...
            <div className="bg-cream p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors group">
              <Users className="w-10 h-10 text-brand mb-6 group-hover:scale-110 transition-transform origin-left" />
            ...
            <div className="bg-cream p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors group lg:col-start-1 lg:col-span-1">
              <ShieldCheck className="w-10 h-10 text-brand mb-6 group-hover:scale-110 transition-transform origin-left" />
            ...
            <div className="bg-cream p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors group md:col-span-2 lg:col-span-1 lg:col-start-2">
              <MessageSquare className="w-10 h-10 text-brand mb-6 group-hover:scale-110 transition-transform origin-left" />
      ...
      <section className="py-32 bg-brand text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="uppercase tracking-[0.2em] text-brand-accent text-xs font-bold mb-4 block">The Roadmap</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative max-w-5xl mx-auto">
            ...
            <div className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-medium mb-3 group-hover:text-brand-accent transition-colors">Consultation & Planning</h4>
            ...
            <div className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-medium mb-3 group-hover:text-brand-accent transition-colors">Design & Scheduling</h4>
            ...
            <div className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-medium mb-3 group-hover:text-brand-accent transition-colors">Execution & Coordination</h4>
            ...
            <div className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-medium mb-3 group-hover:text-brand-accent transition-colors">Quality Check & Delivery</h4>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="order-1 lg:order-2">
              <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">The QuinnHaven Standard</span>
      ...
      <section className="py-32 bg-white border-t border-charcoal/5 text-center">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl font-serif text-brand mb-6">Let’s build something exceptional.</h2>
          ...
          <Link 
            to="/contact" 
            className="inline-flex items-center gap-3 bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-medium hover:bg-charcoal hover:text-white transition-all duration-300 shadow-xl"
          >
            Contact Us Today

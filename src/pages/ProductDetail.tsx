  ...
  return (
    <div className="flex flex-col min-h-screen pt-32 pb-24 bg-cream">
       <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
         <Link to="/products" className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-charcoal/50 hover:text-brand font-bold mb-12">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col justify-center">
               <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold mb-4 block">Product Category</span>
               ...
               <div className="bg-brand/5 p-8 border border-brand/20 mb-8">
                 <h4 className="font-serif text-2xl text-brand mb-2">Request Material Samples</h4>
                 ...
                 <Link to="/book-showroom" className="inline-block bg-charcoal text-white px-8 py-4 uppercase tracking-widest text-xs font-bold hover:bg-brand transition-colors">
                    Book Showroom Visit
                 </Link>
               </div>
            </div>

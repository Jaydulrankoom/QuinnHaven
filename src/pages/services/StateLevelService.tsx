    ...
    <div className="flex flex-col min-h-screen bg-cream font-sans text-charcoal">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-brand uppercase tracking-[0.2em] text-xs font-bold mb-4 block">Service Overview</span>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-brand/5 transform translate-x-4 translate-y-4 rounded-sm" />
              <img loading="lazy" 
      ...
      <section className="py-24 bg-charcoal text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <ShieldCheck className="w-16 h-16 text-brand mx-auto mb-8 opacity-80" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              <PenTool className="w-10 h-10 text-brand mb-6 mx-auto" />
            ...
            <div className="p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              <Hammer className="w-10 h-10 text-brand mb-6 mx-auto" />
            ...
            <div className="p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              <LayoutTemplate className="w-10 h-10 text-brand mb-6 mx-auto" />
            ...
            <div className="p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
              <Star className="w-10 h-10 text-brand mb-6 mx-auto" />
      ...
      <section className="py-32 bg-cream">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Our Methodology</span>
      ...
      <section className="py-24 bg-charcoal text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link to="/portfolio" className="border-b border-white pb-1 uppercase tracking-widest text-xs font-bold hover:text-brand hover:border-brand transition-colors shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif mb-2 group-hover:text-brand transition-colors">{data.portfolio.p1Title}</h3>
            ...
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif mb-2 group-hover:text-brand transition-colors">{data.portfolio.p2Title}</h3>
            ...
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif mb-2 group-hover:text-brand transition-colors">{data.portfolio.p3Title}</h3>
      ...
      <section className="py-32 bg-charcoal text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <Link 
              to="/contact"
              className="bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-bold hover:bg-charcoal hover:text-white transition-all shadow-xl w-full sm:w-auto"
            >
              Book a Consultation
            </Link>
            <Link 
          ...
          <p className="text-sm font-light text-white/60 tracking-widest uppercase">
            Call us directly at <a href={`tel:${BRAND.phone.replace(/[^0-9]/g, '')}`} className="text-brand font-bold hover:underline">{BRAND.phone}</a>
          </p>
        </div>
      </section>
    </div>

...
export default function DynamicLocationService() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-cream font-sans text-charcoal selection:bg-brand selection:text-white">
      ...
      <section className="relative w-full flex items-center justify-center text-center mt-24 py-20 lg:py-32 min-h-[500px] md:min-h-[60vh]">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 text-white pt-10">
          ...
          >
            <span className="flex items-center justify-center gap-2 text-white uppercase tracking-[0.2em] text-sm font-bold mb-4">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[4rem] xl:text-[4.5rem] font-serif leading-tight mb-6 mt-2 tracking-tight capitalize">
              {seoData.heroTitle} <span className="italic text-brand-accent">{locationName}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link 
                to="/contact"
                className="bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-bold hover:bg-charcoal transition-all duration-300 shadow-xl w-full sm:w-auto border border-brand hover:border-white"
              >
                Book a Consultation
              </Link>
              <Link 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="order-1 lg:order-2">
              <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Our Expertise</span>
              <h2 className="text-3xl lg:text-5xl font-serif text-brand mb-6 capitalize">{seoData.expertiseTitle}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">Premium Materials</span></div>
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">Custom Layouts</span></div>
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">Structural integrity</span></div>
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">3D Architecture</span></div>
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">Elite Craftsmanship</span></div>
                <div className="flex items-center gap-3"><CheckCircle2 className="text-brand w-5 h-5 shrink-0" /><span className="font-medium text-sm uppercase tracking-wider">Local Installation</span></div>
              </div>
            </div>
      ...
      <section className="py-24 bg-charcoal text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <MapPin className="w-16 h-16 text-brand mx-auto mb-8 opacity-80" />
          ...
          <div className="text-2xl font-serif italic text-brand-accent border-l-4 border-brand pl-6 py-2 mx-auto max-w-3xl text-left">
      ...
      <section className="py-32 bg-cream">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Methodology</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {processSteps.map((step, idx) => {
              ...
              return (
              <div key={idx} className="bg-white p-10 border border-charcoal/5 shadow-sm hover:border-brand transition-colors relative group">
                <span className="absolute top-8 right-8 text-6xl font-serif text-charcoal/5 group-hover:text-brand/10 transition-colors pointer-events-none">
                  0{idx + 1}
                </span>
                <div className="w-14 h-14 bg-brand/10 text-brand flex items-center justify-center rounded-sm mb-8 group-hover:scale-110 transition-transform origin-left">
                  {icons[idx] || <Hammer />}
                </div>
      ...
      <section className="py-24 bg-white border-y border-charcoal/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
               <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Featured Transformations</span>
               <h2 className="text-4xl lg:text-5xl font-serif text-charcoal capitalize">{serviceType} Projects<br />in {locationName}</h2>
            </div>
            <Link to="/portfolio" className="border-b border-charcoal pb-1 uppercase tracking-widest text-xs font-bold hover:text-brand hover:border-brand transition-colors shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif text-charcoal mb-2 group-hover:text-brand transition-colors">Architectural Masterpiece</h3>
            ...
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif text-charcoal mb-2 group-hover:text-brand transition-colors">Modern Reorganization</h3>
            ...
            <div className="group cursor-pointer">
              ...
              <h3 className="text-xl font-serif text-charcoal mb-2 group-hover:text-brand transition-colors">Estate Integration</h3>
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Client Success</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-10 border border-charcoal/5 shadow-sm relative">
              <Quote className="absolute top-6 right-6 w-12 h-12 text-brand/10" />
              <div className="flex gap-1 text-brand mb-6"><Star className="w-4 h-4 fill-current"/><Star className="w-4 h-4 fill-current"/><Star className="w-4 h-4 fill-current"/><Star className="w-4 h-4 fill-current"/><Star className="w-4 h-4 fill-current"/></div>
      ...
      <section className="py-24 bg-white border-y border-charcoal/5">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="uppercase tracking-[0.2em] text-brand text-xs font-bold mb-4 block">Knowledge Base</span>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="font-serif text-lg text-brand pr-8">{faq.q}</span>
                  <ChevronDown 
                    className={`w-5 h-5 text-brand shrink-0 transition-transform duration-300 ${openFaq === index ? "rotate-180" : ""}`} 
                  />
                </button>
                <AnimatePresence>
                  {openFaq === index && (
      ...
      <section className="py-32 bg-charcoal text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <CalendarDays className="w-16 h-16 text-brand mx-auto mb-8" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <Link 
              to="/contact"
               className="bg-brand text-white px-10 py-5 uppercase tracking-widest text-sm font-bold hover:bg-charcoal hover:text-white transition-all duration-300 shadow-xl w-full sm:w-auto border border-brand hover:border-white"
            >
              Book a Consultation
            </Link>
            <Link 
          ...
          <p className="text-sm font-light text-white/60 tracking-widest uppercase">
            Or speak directly to a master designer at <a href={`tel:${BRAND.phone.replace(/[^0-9]/g, '')}`} className="text-brand font-bold hover:underline">{BRAND.phone}</a>
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-cream text-charcoal border-t border-charcoal/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className="font-serif text-2xl text-brand mb-4">About Our Service Area</h3>
            ...
            <div>
              <h3 className="font-serif text-2xl text-brand mb-4">Explore Related Interior Services</h3>
              <ul className="space-y-3 font-light text-sm">
                <li>
                  <Link to={`/services/kitchen-design-${parsedLocation}`} className="text-brand hover:underline hover:text-brand transition-colors capitalize">
                    Kitchen Design {locationName}
                  </Link>
                </li>
                <li>
                  <Link to={`/services/custom-cabinets-design-${parsedLocation}`} className="text-brand hover:underline hover:text-brand transition-colors capitalize">
                    Custom Cabinets Design {locationName}
                  </Link>
                </li>
                <li>
                  <Link to={`/services/bathroom-remodeling-${parsedLocation}`} className="text-brand hover:underline hover:text-brand transition-colors capitalize">

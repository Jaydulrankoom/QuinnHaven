  ...
  return (
    <div className="flex flex-col min-h-screen pt-32 bg-cream text-charcoal">
      ...
      <section className="pb-16 px-6 max-w-7xl mx-auto w-full">
        <Link to="/portfolio" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand hover:text-brand transition-colors mb-10">
          <ArrowLeft className="w-4 h-4" /> Back to Portfolio
        </Link>
        <div className="flex justify-between items-end flex-wrap gap-8">
          <div>
            <span className="text-brand uppercase tracking-[0.3em] text-xs font-bold mb-4 block">Case Study</span>
            <h1 className="text-4xl md:text-6xl font-serif text-brand mb-4">{project.title}</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
            ...
            <div className="md:col-span-7">
              <h2 className="font-serif text-3xl text-brand mb-6">Project Overview</h2>
        ...
        <section className="py-24 bg-cream">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="font-serif text-3xl md:text-4xl text-brand">Project Gallery</h2>
            </div>
      ...
      <section className="py-24 bg-charcoal text-white text-center px-6">
        ...
        <Link to="/contact" className="inline-block bg-brand text-white px-10 py-4 uppercase tracking-widest text-sm font-bold hover:bg-charcoal hover:text-white transition-all duration-300">
          Book a Consultation
        </Link>
      </section>
